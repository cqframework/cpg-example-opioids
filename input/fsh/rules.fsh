...
* author[+].name = "Kensaku Kawamoto, MD, PhD, MHS"
...
RuleSet: PlanDefinitionPurposeAndUsage
...
RuleSet: ActivityDefinitionPurposeAndUsage
...
RuleSet: UseContext(coding, display)
* useContext[+]
  * code = $usage-context-type#focus "Clinical Focus"
